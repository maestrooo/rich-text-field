...
export function FormattingButton() {
  ...
  const handleOnSelect = useCallback(
    (value: string) => {
      ...
      const headingLevel = value.split("-")[1]
        ? (parseInt(value.split("-")[1], 10) as HeadingElement["level"])
        : undefined;
    ...
    <s-box>
      ...
      <s-popover ref={popoverRef} id="rich-text-field-formatting-menu">
        <s-clickable
          ...
          minInlineSize="100%"
          paddingInline="large"
          onClick={() => handleOnSelect("paragraph")}
          background={
            isFormattingActive(editor, "paragraph") ? "subdued" : "base"
          }
        >
          <s-stack direction="inline" columnGap="small-200" alignItems="center">
            {isFormattingActive(editor, "paragraph") && (
        ...
        <s-clickable
          ...
          minInlineSize="100%"
          paddingInline="large"
          onClick={() => handleOnSelect("heading-1")}
          background={
            isFormattingActive(editor, "heading", 1) ? "subdued" : "base"
          }
        >
          <s-stack direction="inline" columnGap="small-200" alignItems="center">
            {isFormattingActive(editor, "heading", 1) && (
              <s-icon type="check" size="small"></s-icon>
            )}
            <s-heading>
        ...
        <s-clickable
          ...
          minInlineSize="100%"
          paddingInline="large"
          onClick={() => handleOnSelect("heading-2")}
          background={
            isFormattingActive(editor, "heading", 2) ? "subdued" : "base"
          }
        >
          <s-stack direction="inline" columnGap="small-200" alignItems="center">
            {isFormattingActive(editor, "heading", 2) && (
              <s-icon type="check" size="small"></s-icon>
            )}
            <s-heading>
        ...
        <s-clickable
          ...
          minInlineSize="100%"
          paddingInline="large"
          onClick={() => handleOnSelect("heading-3")}
          background={
            isFormattingActive(editor, "heading", 3) ? "subdued" : "base"
          }
        >
          <s-stack direction="inline" columnGap="small-200" alignItems="center">
            {isFormattingActive(editor, "heading", 3) && (
              <s-icon type="check" size="small"></s-icon>
            )}
            <s-heading>
        ...
        <s-clickable
          ...
          minInlineSize="100%"
          paddingInline="large"
          onClick={() => handleOnSelect("heading-4")}
          background={
            isFormattingActive(editor, "heading", 4) ? "subdued" : "base"
          }
        >
          <s-stack direction="inline" columnGap="small-200" alignItems="center">
            {isFormattingActive(editor, "heading", 4) && (
              <s-icon type="check" size="small"></s-icon>
            )}
            <s-heading>
        ...
        <s-clickable
          ...
          minInlineSize="100%"
          paddingInline="large"
          onClick={() => handleOnSelect("heading-5")}
          background={
            isFormattingActive(editor, "heading", 5) ? "subdued" : "base"
          }
        >
          <s-stack direction="inline" columnGap="small-200" alignItems="center">
            {isFormattingActive(editor, "heading", 5) && (
              <s-icon type="check" size="small"></s-icon>
            )}
            <s-heading>
        ...
        <s-clickable
          ...
          minInlineSize="100%"
          paddingInline="large"
          onClick={() => handleOnSelect("heading-6")}
          background={
            isFormattingActive(editor, "heading", 6) ? "subdued" : "base"
          }
        >
          <s-stack direction="inline" columnGap="small-200" alignItems="center">
            {isFormattingActive(editor, "heading", 6) && (
              <s-icon type="check" size="small"></s-icon>
            )}
            <s-heading>
